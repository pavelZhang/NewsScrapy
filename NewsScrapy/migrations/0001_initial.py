    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_model', models.CharField(max_length=64)),
                ('ipmi_user', models.CharField(max_length=64)),
                ('ipmi_password', models.CharField(max_length=64)),
                ('ipaddr', models.CharField(max_length=64, validators=[django.core.validators.validate_ipv4_address])),
